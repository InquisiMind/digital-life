...
const routes = [
  ...
  // === 实例台 ===
  {
    ...
    children: [
      ...
      { path: 'memories', component: InstanceMemories, meta: { title: '记忆 / 联想', icon: 'Collection', group: 'persistent' } },
      { path: 'scratchpad', component: InstanceMemories, meta: { title: '短期暂存', icon: 'Memo', group: 'ephemeral' } },
